...
public class TlsClientHello extends KaitaiStruct {
    ...
    public static class ServerName extends KaitaiStruct {
        ...
        public ServerName(KaitaiStream _io, Sni _parent) {
            super(_io);
            this._parent = _parent;
            _read();
        }

        public ServerName(KaitaiStream _io, Sni _parent, TlsClientHello _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
    ...
    public static class Sni extends KaitaiStruct {
        ...
        public Sni(KaitaiStream _io, Extension _parent) {
            super(_io);
            this._parent = _parent;
            _read();
        }

        public Sni(KaitaiStream _io, Extension _parent, TlsClientHello _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
    ...
    public static class Alpn extends KaitaiStruct {
        ...
        public Alpn(KaitaiStream _io, Extension _parent) {
            super(_io);
            this._parent = _parent;
            _read();
        }

        public Alpn(KaitaiStream _io, Extension _parent, TlsClientHello _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
    ...
    public static class Protocol extends KaitaiStruct {
        ...
        public Protocol(KaitaiStream _io, Alpn _parent) {
            super(_io);
            this._parent = _parent;
            _read();
        }

        public Protocol(KaitaiStream _io, Alpn _parent, TlsClientHello _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
    ...
    public static class Extension extends KaitaiStruct {
        ...
        public Extension(KaitaiStream _io, Extensions _parent) {
            super(_io);
            this._parent = _parent;
            _read();
        }

        public Extension(KaitaiStream _io, Extensions _parent, TlsClientHello _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
