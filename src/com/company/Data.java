...
class Data {
        ...
        final static int leftIndent = 25; //размещение окна на дисплее, отступ слева,  в процентах
        ...
        final static CRectangle clStackKBounds = new CRectangle(addKBounds.getLeft(), addKBounds.getTop()+addKBounds.getHeight()+5, addKBounds.getWidth(),addKBounds.getHeight());
        ...
        final static CRectangle ActivePacketsBounds = new CRectangle(StackProtocolsBounds.getLeft()+StackProtocolsBounds.getWidth()+2*uniIndent, frameHeight-2*uniIndent-260,frameWidth-addKBounds.getLeft()-addKBounds.getWidth()-uniIndent-4,260);  //расположение области пути
        final static CRectangle filterKBounds = new CRectangle(ActivePacketsBounds.getLeft()+ActivePacketsBounds.getWidth()-100, ActivePacketsBounds.getTop()-100-uniIndent, 100, 100);
}
